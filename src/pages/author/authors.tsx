...
import AuthorTabs from "./tabs.tsx";
import {
  authorCard,
  authAvatar,
  socBtn,
  ...
  followers,
  authorName,
} from "./author.styles.ts";
import { useTranslation } from "react-i18next";

export const AuthorPageView = () => {
        ...
        <Card className={authorCard()}>
          ...
          <CardContent className="flex-grow text-center md:text-left">
            <CardDescription className="space-y-4">
              <div className={authorName()}>Jane Doe</div>
              <p className="text-md mb-4 text-mutedForeground">
